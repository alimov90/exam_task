...
function SingleSeries(props) {
    ...
    return (
        ...
        <div className="single-series h-auto">
            <div className="header  ">
                <div className="d-flex justify-content-between mb-2">
                    <h4 className="  mx-5">Movie details</h4>
                    <button className="btn btn-warning">
                        <Link className="nav-link  fw-bold border-warning fs-6  " to="/series" >Back to Series</Link>
                    </button>
                </div>
            ...
            <div className="actors-m text-center mt-5 h-auto">
                <p className="text-decoration-underline">Cast</p>
                <div className="d-flex justify-content-between mb-2">
