...
export default function Movies(props) {
    ...
    return (
        <div className="">
                            ...
                            {call.genreList.map((item,index)=>(
                                <div className="col-xl-3 col-3 text-center mb-2">
                                    <Link className="" to="/sorting">
                                        <button key={index} className="btn text-white bg-secondary btn-outline-danger mx-2 my-2 btn-sm" onClick={()=>call.getGenreData(item.id,index)}>{item.name}</button>
                                    </Link>
                                </div>
                            ))}
                    </div>
            ...
            <Stack spacing={1} >
                <Typography>
                    <div className="text-white text-decoration-underline"><h1 className="text-center text-danger fw-bold my-3">Movies</h1></div>
                    {/*<h1 className="text-center text-danger fw-bold my-3">Movies</h1>*/}
